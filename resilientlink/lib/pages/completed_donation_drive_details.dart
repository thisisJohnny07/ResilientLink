...
class CompletedDonationDriveDetails extends StatefulWidget {
  final String donationId;
  const CompletedDonationDriveDetails({super.key, required this.donationId});

  @override
  State<CompletedDonationDriveDetails> createState() =>
      _CompletedDonationDriveDetailsState();
}

class _CompletedDonationDriveDetailsState
    extends State<CompletedDonationDriveDetails> {
